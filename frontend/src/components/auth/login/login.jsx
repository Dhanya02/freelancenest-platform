...
const Login = () => {
    ...
    // const { isDeveloper, isProjectManager } = location.state || {}
    ...
    // const { isDeveloper, isProjectManager } = state || {};
    console.log('at login:', isDeveloper, isProjectManager);
    ...
    //                 setErrorMessage('Invalid email or password'); // Update error message for invalid credentials
    //             } else {
            ...
            try {
                ...
                if (isDeveloper) {
                    ...
                    const response = await fetch('http://localhost:3000/freelancer/developers', {
                        ...
                        body: JSON.stringify({ email: googleUser.email, isDeveloper: true }),
                    });
                    if (!response.ok) {
                        throw new Error('Failed to add developer to the database');
                    }
